...
public class RevisionService {
	...
	public Optional<RevisionDto> findRevisionDto(final Class<?> entityClass, final Object entityId, final RevisionType revisionType, final Object revisionEntity) {
		...
		revisionDto.setContext(Map.of(
			"acceptLanguage", currentRevisionEntity.getAcceptLanguage(),
			"userAgent", currentRevisionEntity.getUserAgent()
		));
